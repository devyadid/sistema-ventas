...
<head>
  ...
  <title>Golosinas Tipicas de la Abuela</title>
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block">
                <img src="sistema/img/logo1.png" class="login_logo">
                <p class="login_titulo">GOLOSINAS TIPICAS DE LA <b class="login_titulo-b">ABUELA</b></p>
              </div>
              <div class="col-lg-6">
                <div class="p-5">
