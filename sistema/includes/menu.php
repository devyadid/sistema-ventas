<!-- Sidebar -->
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #0c132f;">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
		...
		<div class="sidebar-brand-text mx-3">Golosinas Tipicas de la Abuela</div>
	</a>
	...
	<li><img style="height: 10rem; width: 10rem; margin: 7rem 0 0 .8rem" src="img/fondo.png" alt="img"></li>
	<!-- <li><img style="height: 10rem; width: 10rem; margin: 7rem 0 0 .8rem" src="fondo.webp" alt="img"></li> -->
