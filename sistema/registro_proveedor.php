        ...
        <div class="col-lg-6 m-auto">
            ...
            <div class="card">
                <form action="" autocomplete="off" method="post" class="card-body p-2">
                    ...
                    <div class="form-group">
                        <label for="contacto">Numero de Identificacion</label>
                        <input type="text" placeholder="Ingrese Numero de Identificacion" name="contacto" id="contacto" class="form-control">
                    </div>
                    <div class="form-group">
