...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800"><b>Panel de Administración</b></h1>
	</div>
	...
	<!-- Page Heading -->
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800"><b>Configuración</b></h1>
	</div>
	<div class="row">
		<div class="col-lg-6">
			<div class="card">
				<div class="card-header menu_bg-nav text-white" style="background-color: #12295b;">
				...
				<div class="card-body">
					...
					<ul class="list-group "> <!-- list-group-item-->
						<li class="active" style="background-color: #12295b; color:white; border-radius: .2rem; padding: .7rem;">Cambiar Contraseña</li>
		...
		<?php if ($_SESSION['rol'] == 1) { ?>
			<div class="col-lg-6" >
				<div class="card" >
					<h2 style="color: dimgrey; font-size: 1rem; margin: .9rem .9rem .9rem .9rem; font-weight: 100;"><b> Datos de la Empresa </b></h2>
					<div class="card-header menu_bg-nav text-white" style="background-color: #12295b; >
						Datos de la Empresa
					</div>
					<div class="card-body">
						<form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
							<div class="form-group">
								<label>Identificacion de la Empresa:</label>
								<input type="number" name="txtDni" value="<?php echo $dni; ?>" id="txtDni" placeholder="Identificacion de la Empresa" required class="form-control">
							</div>
							<div class="form-group">
								<label>Nombre:</label>
							...
							<div class="form-group">
								...
								<input type="text" name="txtRSocial" class="form-control" value="<?php echo $razonSocial; ?>" id="txtRSocial" placeholder="Administrador">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>IVA (%):</label>
								<input type="text" name="txtIgv" class="form-control" value="<?php echo $igv; ?>" id="txtIgv" placeholder="" required>
							</div>
		...
		<?php } else { ?>
			<div class="col-lg-6">
				<div class="card">
					<div class="card-header menu_bg-nav text-white">
						Datos de la Empresa
					</div>
					<div class="card-body">
						<div class="p-3">
